...
<s:div cssClass="login">
    ...
    <s:form action="clientLogin" method="post">
        <s:div cssClass="u"> 
            <s:textfield theme="simple" cssClass="uname" name="client.username" value="账号名"/>
       </s:div> 
        <s:div cssClass="p">
            <s:password theme="simple" cssClass="pwd" name="client.password" value="密码"/>
       </s:div>
