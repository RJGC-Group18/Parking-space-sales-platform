        ...
        $.ajax({
            ...
            success: function(result){
                ...
                for(j = 1; j < arr.length; j++) {
                    var arr1=arr[j].split(/"sender":"|","message":"|","receiver":"|","date":"|"}/);
            ...
            <ul>
                <%  ArrayList<String> users =new ArrayList();
                    ...
                    try {
                        ...
                        ResultSet result1 = statement.executeQuery("select * from client where client.cid in(select DISTINCT cid from dealing where pay is NULL) ORDER BY cid");
                        while (result1.next()) {
